<template>
  <div ref="spinnerModal" class="modal fade spinnerModal" tabindex="-1" aria-labelledby="exampleModalLabel"
    aria-hidden="true">
    <div class="modal-dialog modal-dialog-centered d-flex align-items-center justify-content-center text-white">
      <div class="text-center">
        <svg xmlns="http://www.w3.org/2000/svg" class="loadingSvg" viewBox="0 0 512 512">
          <path
        ...
        <div class="fs-6 fw-normal">{{ loadingMessage }}</div>
      </div>
    </div>
  </div>
</template>
...
export default {
  ...
  mounted () {
    ...
    this.spinnerModal = new bootstrap.Modal(this.$refs.spinnerModal)
  }
}
</script>
<style scoped>
...
.spinnerModal .loadingSvg{
  width: 40px;
  height: 40px;
  animation: loading .35s cubic-bezier(0,0,.15,1) infinite alternate;
}
