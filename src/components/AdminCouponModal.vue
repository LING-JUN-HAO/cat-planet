<template>
              ...
              <div class="col-sm-12">
                ...
                <div class="row">
                  <div class="mb-3 col-md-6">
                    ...
                    <input id="percent" type="text" class="form-control" v-model="newTemProduct.percent" placeholder="請輸入折扣比例">
                  </div>
                  <div class="mb-3 col-md-6">
  ...
  export default {
    ...
    methods: {
      ...
      updateTempProduct () {
        this.newTemProduct.due_date = moment(this.due_date).unix()
    ...
    watch: {
      ...
      tempProduct: function (newVal, oldVal) {
        ...
        this.due_date = this.dataFormatter(newVal.due_date)
      }
    },
    mounted () {
